...
private[sources] case class EntityAndInsertAction(entity: Option[Entity], insert: Option[Insert])
private[sources] case class ExtractEntityAndInsertAction(state: EntityAndInsertAction) extends StatefulTransformer[EntityAndInsertAction] {
